...
@nc.vo.annotation.AggVoInfo(parentVO = "nc.vo.erm.sharerule.ShareruleVO")
public class AggshareruleVO extends HYBillVO implements IExAggVO{
	...
	public String[] getTableNames(){
		...
		return new String[]{
                                           nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("201100_0","0201100-0033")/*@res "分摊对象明细"*/,
                                            nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("201100_0","0201100-0034")/*@res "分摊数据"*/,
                         };
	}

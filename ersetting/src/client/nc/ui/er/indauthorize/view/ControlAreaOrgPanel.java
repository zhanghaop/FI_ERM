...
import nc.ui.er.reimtype.ref.ControlAreaRefModel;
...
public class ControlAreaOrgPanel extends UIPanel implements
	...
	private String labelName = null;// 注入
	private UILabel label = null;
	private IAppModelDataManager dataManager;// 注入
	private AbstractUIAppModel model;// 注入
	...
	public UIRefPane getRefPane() {
		if (refPane == null) {
			...
			ControlAreaRefModel refModel = new ControlAreaRefModel(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("ersetting_0","02011001-0012")/*@res "管控范围"*/);

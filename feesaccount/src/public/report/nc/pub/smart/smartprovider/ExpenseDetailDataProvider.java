...
public class ExpenseDetailDataProvider extends AbsReportDataProvider{
	...
	private static final String[] CAPTIONS = {
			...
			nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002313")/*@res "日期"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("feesaccount_0","02011001-0078")/*@res "单据类型PK"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0000807")/*@res "单据类型"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("feesaccount_0","02011001-0073")/*@res "币种PK"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0001755")/*@res "币种"*/,
			 ...
			 nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002185")/*@res "摘要"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("feesaccount_0","02011001-0079")/*@res "单据PK"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UCMD1-000144")/*@res "单据编号"*/,nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0000240")/*@res "会计期间"*/,

		     nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("feesaccount_0","02011001-0074")/*@res "报销金额原币"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("feesaccount_0","02011001-0075")/*@res "报销金额本币"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("feesaccount_0","02011001-0076")/*@res "报销金额集团本币"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("feesaccount_0","02011001-0077")/*@res "报销金额全局本币"*/,
...
//		// 单据类型PK
//		fld = new Field();
//		fld.setCaption("单据类型PK");
//		fld.setDbColumnType(Types.VARCHAR);
//		fld.setFldname("pk_billtype"); // 单据类型PK
//		fld.setPrecision(50);
//		fld.setScale(2);
//		metaData.addField(fld);
//
...
//		fld.setCaption("币种PK");
//		fld.setDbColumnType(Types.VARCHAR);
//		fld.setFldname("pk_currtype"); // 币种PK
//		fld.setPrecision(20);
//		fld.setScale(0);
//		metaData.addField(fld);
//
...
//		// 财务组织
//		fld = new Field();
//		fld.setCaption("财务组织PK");
//		fld.setDbColumnType(Types.VARCHAR);
//		fld.setFldname("pk_org"); // 财务组织
//		fld.setPrecision(50);
//		fld.setScale(2);
//		metaData.addField(fld);
//		// 财务组织
...
//		// 以下为动态金额字段
//		fld = new Field();
//		fld.setCaption("报销本币金额");
//		fld.setDbColumnType(Types.DECIMAL);
//		fld.setFldname("bbje");  //报销本币金额
//		fld.setPrecision(31);
//		fld.setScale(8);
//		metaData.addField(fld);
//
//		fld = new Field();
//		fld.setCaption("报销原币金额");
//		fld.setDbColumnType(Types.DECIMAL);
//		fld.setFldname("ybje"); //报销原币金额
//		fld.setPrecision(31);
//		fld.setScale(8);
//		metaData.addField(fld);
//

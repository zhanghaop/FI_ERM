 ...
 * @author liansg
 * @version V6.0
 * @since V6.0 创建时间：2010-12-22 下午03:34:15
 */
@SuppressWarnings("restriction")
public class ExpenseBalanceDataProviderDesigner implements IProviderDesignWizard {

	@Override
	public Provider design(Container parent, Provider provider,
			SmartContext context) {
		return new ExpenseBalanceDataProvider();
	}

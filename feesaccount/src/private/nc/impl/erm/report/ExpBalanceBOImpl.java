 ...
 */
public class ExpBalanceBOImpl extends FipubSqlExecuter implements IExpBalanceBO {
    ...
    public DataSet queryExpenseBalance(ReportQueryCondVO queryVO,
        ...
        if (queryVO == null) {
            ...
            try {
                resultDataSet.setMetaData(new ExpBalanceDataProvider().provideMetaData(null));

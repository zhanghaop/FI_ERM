...
public class AccCardRateDecimalListener implements IBillModelDecimalListener2 {
	...
	public AccCardRateDecimalListener(BillModel model, BillCardPanel cardPanel, String[] target, String rateType,
			String source) {
		this.target = target;

...
public class BxQueryDLG extends QueryConditionDLG {
	...
	public final String STR_JK = nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("expensepub_0", "02011002-0041")/* @res* "借款"*/;

	public final String STR_BX = nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("expensepub_0", "02011002-0042")/* @res* "报销"*/;
	...
	private void initQryDlg(Container parent, final String nodecode) {
		...
		//编辑后过滤
		BXQryTplUtil.registerCriteriaEditorListener(this,orgRelKeyList,fyOrgRelKeyList,userOrgRelKeyList);

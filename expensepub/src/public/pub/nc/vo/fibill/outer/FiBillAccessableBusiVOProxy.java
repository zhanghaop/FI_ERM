...
public class FiBillAccessableBusiVOProxy extends FiBillAccessableBusiVO {
	...
	/**
	 * @param proxyed
	 *            被代理的类，必须同时实现预算IBillsControl, IBillDataGeter接口。
	 */
	public FiBillAccessableBusiVOProxy(FiBillAccessableBusiVO proxyed) {
		super();
	 ...
	 * (non-Javadoc)
	 * 
	 * @see nc.vo.ntb.outer.IAccessableBusiVO#getAllUpLevels(java.lang.String,
	 * java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * nc.vo.ntb.outer.IAccessableBusiVO#getAttributesValue(java.lang.String[])
	 */
...
//	}
	...
	public String getPKOrg(String att_fld) {
		return proxyed.getPKOrg(att_fld);
	}

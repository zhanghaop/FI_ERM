...
public class BXQueryUtil implements PubConstData{
    ...
    public final static Integer Voucher_NotCreated=new Integer(0);
    public final static Integer Voucher_Created=new Integer(1);
    public final static Integer Voucher_Singed=new Integer(2);
...
//		}
	...
	private static QryCondArrayVO getCondIncludeDr() {
		...
		voTmp.setQryfld("dr");
		voTmp.setFldtype(new Integer(INTEGER));
		voTmp.setBoolopr("=");
		voTmp.setValue("0");
		v.addElement(voTmp);
	...
	private static QryCondArrayVO getCondQcbz(boolean isQc) {
        ...
        voTmp.setFldtype(new Integer(STRING));
        voTmp.setBoolopr("=");

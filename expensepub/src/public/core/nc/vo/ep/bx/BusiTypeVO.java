...
<?xml version="1.0" encoding="GBK"?>
 <billtypes>
    <billtype code="****" templetflag="Y">
    	<interfaces>    	    	
    	    <interface name="IBodyPrint">
		<implementation>nc.ui.ep.bx.BodyPrint</implementation>
	    </interface>    	    	   	   
    	    <interface name="IBodyUIController">
		<implementation>nc.ui.ep.bx.BodyController</implementation>
	    </interface>  	    	
    	    <interface name="IBXBusItemBO">
		<implementation>nc.bs.ep.bx.BXBusItemBO</implementation>
	    </interface>    	      	
    	</interfaces> 
    	<costentity_billitems>
    	    <billitem itemkey=""/>	
    	    <billitem itemkey=""/>	
    	    <billitem itemkey=""/>		
    	</costentity_billitems> 
    	...
    	<tablecodes>
    	    <tablecode code="" canAddRow="N"/>
    	    <tablecode code="" canAddRow="Y"/>
    	</tablecodes>	
    </billtype> 
 </billtypes>
 *
 */
public class BusiTypeVO implements Serializable, IConfigVO{

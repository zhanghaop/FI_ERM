...
public abstract class JKBXHeaderVO extends SuperVO implements IFYControl{
	 ...
	 * 审核日期显示日期，不显示时间
	 */
	protected UFDate shrq_show;
	
	/**
	 * 此方法不公开
	 * @param shrqShow
	 */
	protected void setShrq_show(UFDate shrqShow) {
		shrq_show = getShrq()!=null?getShrq().getDate():null;
	}
	...
	public static String[] getFieldNotInit() {
		return new String[] {JKBXR,DJLXBM,PK_GROUP,OPERATOR,MODIFIER,MODIFIEDTIME,CREATOR,CREATIONTIME,PK_JKBX,DJBH,DJRQ,TS,DJZT,
				KJND,KJQJ,PAYMAN,PAYDATE,PAYFLAG,PK_ORG_V,FYDWBM_V,DWBM_V,PK_PCORG_V,DEPTID_V,FYDEPTID_V,DWBM,DEPTID,BBHL,SKYHZH,JSR,APPROVER};
	}
	...
	public static String[] getFieldNotCopy() {
		return new String[] {ZHRQ,PK_ITEM,SXBZ, JSH, DJZT, SPZT, TS, DR, MODIFIER, OPERATOR, APPROVER,MODIFIEDTIME,PK_JKBX, DJBH, DJRQ , KJND , KJQJ, JSRQ, SHRQ,JSR,CONTRASTENDDATE,PAYMAN,PAYDATE,PAYFLAG};
	}
	...
	public static String[] getJeField() {
		return new String[] {
				...
				YBJE,  BBJE,TOTAL,
				YBYE,  BBYE, 
				GLOBALCJKBBJE,GLOBALZFBBJE,GLOBALHKBBJE,GLOBALBBJE,GLOBALBBYE,
				GROUPCJKBBJE,GROUPZFBBJE,GROUPHKBBJE,GROUPBBJE,GROUPBBYE
		};
	}
	...
	public static String[] getYbjeField() {
		return new String[] {
				CJKYBJE,ZFYBJE,HKYBJE,YBJE,TOTAL,YBYE,YJYE};
	}
	/**
	 * 返回本币金额字段
	 * @return
	...
	public static String[] getBbjeField() {
		return new String[] {
				CJKBBJE,ZFBBJE,HKBBJE,BBJE,BBYE,
				GLOBALCJKBBJE,GLOBALZFBBJE,GLOBALHKBBJE,GLOBALBBJE,GLOBALBBYE,
				GROUPCJKBBJE,GROUPZFBBJE,GROUPHKBBJE,GROUPBBJE,GROUPBBYE
		};
	}
	...
	protected void validateNotNullField2() {
		...
		message.append(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000285")/*@res "表头下列字段不能同时为空:"*/);
	...
	protected void validateNullField() throws NullFieldException {
		...
		String[] str={
				...
				JKBXHeaderVO.FYDWBM,
				JKBXHeaderVO.PK_ORG,
				JKBXHeaderVO.OPERATOR,
				JKBXHeaderVO.PK_GROUP,
				};
	...
	public String getFieldName(String field) {
		...
		if(field.equals(PK_ORG))
			if(djdl.equals(BXConstans.BX_DJDL))
				return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("expensepub_0","02011002-0131")/*@res "报销单位"*/;
			else
				return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("expensepub_0","02011002-0132")/*@res "借款单位"*/;
...
//		public static final String FREECUST = "freecust";
			...
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("expensepub_0","02011002-0133")/*@res "客商银行账号"*/;
		else if(field.equals(FREECUST))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0002272")/*@res "散户"*/;
		else if(field.equals(FYDEPTID))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000223")/*@res "费用承担部门"*/;
		else if (field.equals(FYDWBM))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000287")/*@res "费用承担公司"*/;
		else if (field.equals(DWBM))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000288")/*@res "报销人公司"*/;
			...
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000245")/*@res "本币金额"*/;
		else if (field.equals(ISCHECK))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000289")/*@res "支票额度"*/;
		else if (field.equals(ISINITGROUP))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("expensepub_0","02011002-0134")/*@res "集团常用单据"*/;
		else if (field.equals(ZPXE))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000290")/*@res "支票限额"*/;
		else if (field.equals(BZBM))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000291")/*@res "币种编码"*/;
		else if (field.equals(JKBXR))
			if (djdl.equals(BXConstans.BX_DJDL))
				return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000292")/*@res "报销人"*/;
			else
				return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000249")/*@res "借款人"*/;
		else if (field.equals(PJH))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000293")/*@res "票据号"*/;
		else if (field.equals(CHECKTYPE))
			return  nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UC000-0003020")/*@res "票据类型"*/;
		else if (field.equals(BBHL))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000294")/*@res "本币汇率"*/;
		else if (field.equals(SKYHZH))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000295")/*@res "收款银行账号"*/;
		else if (field.equals(FKYHZH))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000296")/*@res "付款银行账号"*/;
		else if (field.equals(JSH))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000297")/*@res "结算号"*/;
			...
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000298")/*@res "合计金额"*/;
		else if (field.equals(DJRQ))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000248")/*@res "单据日期"*/;
		else if (field.equals(KJND))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPT2011-000709")/*@res "会计年度"*/;
		else if (field.equals(KJQJ))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPT2011-000715")/*@res "会计期间"*/;

		else if (field.equals(SZXMID))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000224")/*@res "收支项目"*/;
		else if (field.equals(JOBID))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000221")/*@res "项目"*/;
		else if (field.equals(PROJECTTASK))
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("common","UCMD1-000312")/*@res "项目任务"*/;
		else
			return field;
	}
	...
	public static final String JSFSMC = "jsfsmc";
	...
	/**
	 * VO增加字段, 供界面展示用, 不固化到数据库.
	 * VO增加字段, 供界面展示用, 不固化到数据库.
	 */
	public static final String SELECTED = "selected";
	protected UFBoolean selected = new UFBoolean(false);
...
//			return getShrq();
	...
	public Integer getFx() {
		return isRepayBill()?new Integer(-1):new Integer(1);
	}
	...
	*  返回审批流起点人
	...
	/**
	 * 属性globalzfbbje的Setter方法.
	 * 创建日期:2010-01-18 09:32:58
	 * @param newGlobalzfbbje  UFDouble
	 */
	...
	/**
	 * 属性groupbbye的Setter方法.
	 * 创建日期:2010-01-18 09:32:58
	 * @param newGroupbbye  UFDouble
	 */
	...
	/**
	 * 属性groupzfbbje的Setter方法.
	 * 创建日期:2010-01-18 09:32:58
	 * @param newGroupzfbbje  UFDouble
	 */
	...
	/**
	 * 属性groupbbhl的Setter方法.
	 * 创建日期:2010-01-18 09:32:58
	 * @param newGroupbbhl  UFDouble
	 */
	...
	public static String[] getOrgMultiVersionFieldArray() {
		return (String[]) getOrgMultiVersionFieldMap().values().toArray(
				new String[0]);
	}
	...
	public static String[] getDeptMultiVersionFieldArray() {
		return (String[]) getDeptMultiVersionFieldMap().values().toArray(
				new String[0]);
	}

 ...
 * 借款报销表体业务信息VO
 * @author twei
 * modified by chendya since v6.1 将财务行VO删除，将财务行所有有用字段移植到业务行(报销单早些时候的版本是没有表体行的，所以特意构造了财务行金额传结算，会计平台，预算等)
 * 
...
public class BXBusItemVO extends SuperVO {
	...
	//---------------------------------begin added by chendya 移植财务行---------------------------------
	public static final String[] MONEY_FIELDS = new String[]{"ybje","bbje","ybye","bbye","hkybje","hkbbje","zfybje","zfbbje","cjkybje","cjkbbje"};
	...
	public void validate() throws ValidationException {
		...
		ArrayList<String> notNullFieldNames = new ArrayList<String>(); // errFields record those null
		ArrayList<String> notNullFieldKeys = new ArrayList<String>(); // errFields record those null
		...
		errorMsg.append(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000281")/*@res "表体下列字段不能为空:\n"*/);
	...
	public static String[] getYbjeField() {
		return new String[] {
				CJKYBJE,ZFYBJE,HKYBJE,YBJE,YBYE,FYYBJE,AMOUNT};
	}
	...
	public static String[] getBodyJeFieldForDecimal(){
		return new String[] {
				YBJE, CJKYBJE, ZFYBJE, HKYBJE,FYYBJE,
				BBJE, CJKBBJE, ZFBBJE, HKBBJE,
				AMOUNT,YBYE,

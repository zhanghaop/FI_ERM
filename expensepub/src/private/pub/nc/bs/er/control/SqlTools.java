...
//		QueryVO.getGroupCount加一，唉
		...
		for (int i = 0; i < names.length; i++) {
			if (names[i] == null || names[i].trim().equals("")) {
				throw new Exception(nc.bs.ml.NCLangResOnserver.getInstance().getStrByID("20060504","UPP20060504-000077")/*@res "错误！GroupBy中的字段不可为空！"*/);
			}
...
//				rq = dataType.trim();
//			else
//				throw new Exception(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2011","UPP2011-000391")/*@res "预算传输日期类型错误！！"*/);

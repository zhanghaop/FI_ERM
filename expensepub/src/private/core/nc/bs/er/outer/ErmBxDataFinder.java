...
public class ErmBxDataFinder extends BillTypeSetDataFinder{
	...
	private String createSourceOtherSQL() {
		return "select distinct zb.djlxbm,zb.vouchid  from arap_item zb,er_bxzb fb where fb.pk_item is not null and fb.pk_jkbx=? and zb.vouchid=fb.pk_item and isnull(fb.dr,0)=0 ";
	}
 	private String createForwardOtherSQL() {
		return "select distinct fb.pk_jkbx,fb.pk_corp,fb.djbh,fb.djlxbm from arap_item zb,er_bxzb fb where fb.pk_item is not null and zb.vouchid=? and zb.vouchid=fb.pk_item and isnull(fb.dr,0)=0 ";
	}
 	/*

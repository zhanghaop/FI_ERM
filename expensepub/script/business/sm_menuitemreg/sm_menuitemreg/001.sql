...
insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z310000000000EO1',0,null,null,'Y','报销管理单据录入','20112002','单据录入','1004ZZ10000000000FFL','D20112002','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z310000000000EO2',0,'20110ETEA',null,'N','报销管理差旅费报销单','2011200203','差旅费报销单','1004ZZ10000000000FFL','D2011200203','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z3100000000015O3',0,null,null,'Y',null,'201100','初始设置','1004ZZ10000000000FFL','D201100','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z3100000000015O4',0,'20110ETS',null,'N','报销管理费用类型设置','20110016','费用类型设置','1004ZZ10000000000FFL','D20110016','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z3100000000015O5',0,'20110IASG',null,'N','个人授权设置','20110014','个人授权设置','1004ZZ10000000000FFL','D20110014','2014-04-29 09:52:08')
go
...
insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z310000000003ZIU',0,null,null,'Y','借款明细查询（菜单）','20115002','借款明细查询','1004ZZ10000000000FFL','D20115002','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z310000000003ZIV',0,null,null,'Y','借款余额查询（菜单）','20115001','借款余额查询','1004ZZ10000000000FFL','D20115001','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z310000000003ZIW',0,null,null,'Y','费用明查询（菜单）','20115005','费用明细查询','1004ZZ10000000000FFL','D20115005','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z310000000003ZIX',0,null,null,'Y','费用汇总查询（菜单）','20115004','费用汇总查询','1004ZZ10000000000FFL','D20115004','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z310000000006MFP',0,null,null,'Y',null,'201140','期末处理','1004ZZ10000000000FFL','D201140','2014-04-29 09:52:08')
go
...
insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000000CO0P',0,'20110BMLB',null,'N','报销管理单据管理','20112003','单据管理','1004ZZ10000000000FFL','D20112003','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000000CO0Q',0,'20110BQLB',null,'N','报销管理单据管理','20112004','单据查询','1004ZZ10000000000FFL','D20112004','2014-04-29 09:52:08')
go
...
insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000000DYCL',0,'20110MELB',null,'N','报销管理会议费借款单','2011200202','会议费借款单','1004ZZ10000000000FFL','D2011200202','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000000E4HP',0,'20110CEA',null,'N','报销管理通讯费报销单','2011200205','通讯费报销单','1004ZZ10000000000FFL','D2011200205','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000000E6SZ',0,'20110PEA',null,'N','报销管理礼品费报销单','2011200206','礼品费报销单','1004ZZ10000000000FFL','D2011200206','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000000E6T2',0,'20110EEA',null,'N','报销管理招待费报销单','2011200207','招待费报销单','1004ZZ10000000000FFL','D2011200207','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000000E6T6',0,'20110MEA',null,'N','报销管理会议费报销单','2011200208','会议费报销单','1004ZZ10000000000FFL','D2011200208','2014-04-29 09:52:08')
go
...
insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000000NX44',0,'20110CBS',null,'N','报销管理常用单据设置','20110006','常用单据设置-组织','1004ZZ10000000000FFL','D20110006','2014-04-29 09:52:08')
go
...
insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z310000000019KFP',0,'20111ERR',null,'N',null,'20110029','账表初始化','1004ZZ10000000000FFL','D20110028','2014-04-29 09:53:15')
go
...
insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000002XNP4',0,'2011050504',null,'N',null,'2011500504','单位费用明细账','1004ZZ10000000000FFL','D2011500504','2014-04-29 09:52:08')
go
...
insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000000R2NU',0,'2011090802',null,'N',null,'2011500602','成本中心趋势分析','1004ZZ10000000000FFL','D2011500602','2014-04-29 09:52:08')
go
...
insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000001GG7W',0,null,null,'Y',null,'20111002','费用申请单录入','1004ZZ10000000000FFL','D20111002','2014-04-29 09:52:08')
go

insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000001GG8Q',0,'20110EOCA',null,'N',null,'20114003','结账','1004ZZ10000000000FFL','D20114003','2014-04-29 09:52:08')
go
...
insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z310000000023X2O',0,'20110CBSGII',null,'N',null,'20110009','常用单据设置-集团II','1004ZZ10000000000FFL','D20110009','2014-04-29 09:52:08')
go
...
insert into sm_menuitemreg(pk_menuitem,dr,funcode,iconpath,ismenutype,menudes,menuitemcode,menuitemname,pk_menu,resid,ts) values('1001Z31000000001L871',0,'20111ERQ',null,'N',null,'20110028','查询对象注册','1004ZZ10000000000FFL','D20110029','2014-02-19 08:51:56')
go

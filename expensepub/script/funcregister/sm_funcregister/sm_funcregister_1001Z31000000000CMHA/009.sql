...
insert into sm_busiactivereg(pk_busiactive,busi_pk,code,description,dr,name,ownertype,parent_id,resid,ts) values('1001Z31000000000A58D','20110BMLB_ADD','ADD','单据管理 新增',0,'新增',0,'1001Z31000000000CMHA','20110BMLB_ADD','2014-04-29 09:52:19')
go

insert into sm_busiactivereg(pk_busiactive,busi_pk,code,description,dr,name,ownertype,parent_id,resid,ts) values('1001Z31000000000A58G','20110BMLB_MAINTAIN','MAINTAIN','单据管理 维护',0,'维护',0,'1001Z31000000000CMHA','20110BMLB_MAINTAIN','2014-04-29 09:52:19')
go

insert into sm_busiactivereg(pk_busiactive,busi_pk,code,description,dr,name,ownertype,parent_id,resid,ts) values('1001Z31000000000A58L','20110BMLB_PRINT','PRINT','单据管理 打印',0,'打印',0,'1001Z31000000000CMHA','20110BMLB_PRINT','2014-04-29 09:52:19')
go
...
insert into sm_busiactivereg(pk_busiactive,busi_pk,code,description,dr,name,ownertype,parent_id,resid,ts) values('1001Z310000000026UR6','20110BMLB_Verify','Verify',null,0,'核销预提',0,'1001Z31000000000CMHA','201107_Verify','2014-03-10 11:00:37')
go

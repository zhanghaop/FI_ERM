...
insert into sm_busiactivereg(pk_busiactive,busi_pk,code,description,dr,name,ownertype,parent_id,resid,ts) values('1001Z31000000000A5A3','20110CEA_APPROVE','APPROVE','通讯费报销单 审批',0,'审批',0,'1001Z31000000000DYCR','20110CEA_APPROVE','2014-04-29 09:52:19')
go

insert into sm_busiactivereg(pk_busiactive,busi_pk,code,description,dr,name,ownertype,parent_id,resid,ts) values('1001Z31000000000A5A9','20110CEA_BILL','BILL','通讯费报销单 制单',0,'制单',0,'1001Z31000000000DYCR','20110CEA_BILL','2014-04-29 09:52:19')
go

insert into sm_busiactivereg(pk_busiactive,busi_pk,code,description,dr,name,ownertype,parent_id,resid,ts) values('1001Z31000000000A5BZ','20110CEA_PRINT','PRINT','通讯费报销单 打印',0,'打印',0,'1001Z31000000000DYCR','20110CEA_PRINT','2014-04-29 09:52:19')
go

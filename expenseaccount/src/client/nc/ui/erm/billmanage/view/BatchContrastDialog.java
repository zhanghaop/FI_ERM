...
import nc.ui.arap.bx.ContrastModePanel;
...
public class BatchContrastDialog extends UIDialog implements java.awt.event.ActionListener, nc.ui.pub.beans.ValueChangedListener {
	...
	public BatchContrastDialog(BillManageModel model,String nodecode, String pkCorp) {
	...
	public void actionPerformed(ActionEvent e){
		if (e.getSource().equals(getBtnConfirm())) {
			...
			try {
		        ...
		        MessageDialog.showWarningDlg(this, nc.ui.ml.NCLangRes.getInstance().getStrByID("smcomm", "UPP1005-000070")/* @res "警告" */, e1.getMessage());
				return ;
			}

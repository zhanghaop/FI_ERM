...
public class DocumentAction extends NCAction {
	...
	public  DocumentAction(){
		super();
		this.setBtnName(ErmActionConst.getDocumentName());
		setCode(ErmActionConst.DOCUMENT);
	}
	...
	private void showModal(CostShareVO headvo){
		UIDialog dlg = new UIDialog(getModel().getContext().getEntranceUI(), 
				nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("2006030102","UPP2006030102-001119")/*@res "文档管理"*/);

 ...
 *
 */
public class CSDetailCardAmontDecimalListener implements IBillModelDecimalListener2{
	/**
	 * 原币
	 */
	...
	public CSDetailCardAmontDecimalListener(BillModel billmodel,BillCardPanel cardPanel, String[] targetKeys,
			String rateType) {

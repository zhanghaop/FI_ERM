...
public class MatterAppDataSource implements IDataSource{
	...
	public MatterAppDataSource(String billId, String billtype, String checkman,
			List<AggMatterAppVO> voList) throws BusinessException {
...
//	}
	...
	public static String[] getBodyUFDoubleFields() {
		return new String[] { MtAppDetailVO.ORIG_AMOUNT  };
	}

	public static String[] getHeadUFDoubleFields() {
		return new String[] { MatterAppVO.ORIG_AMOUNT };
	}

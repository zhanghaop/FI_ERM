...
//		}
	...
	private void afterHLChanged(JsonVoTransform e) throws BusinessException {
...
//		resetBodyCShare(e);
	 ...
	 * 
	 */
	public static void onlydealHeadBBje(UFDouble yb) {
...
//		}
	...
	private void afterEditCashProj(JsonVoTransform e) {
...
//		}
	 ...
	 * @throws BusinessException
	 */
	private void afterEditBillDate(EditItemInfoVO e) throws BusinessException {
...
//		resetHlAndJe(e);
	 ...
	 * @throws BusinessException
	 */
	private void resetHlAndJe(JsonVoTransform e) throws BusinessException {
...
////		resetBodyCShare();
	 ...
	 * 费用承担单位版本编辑后事件
	 */
	private void afterEditOrg_v(JsonVoTransform evt) throws BusinessException {
...
//		afterEditMultiVersionOrgField(evt.getKey(), pk_org_v, JKBXHeaderVO.getOrgFieldByVField(evt.getKey()));
	 ...
	 * @throws BusinessException
	 */
	private void afterEditPk_org_v(JsonVoTransform e) throws BusinessException {
...
//			}
	 ...
	 * @throws BusinessException
	 */
	private void afterEditZy(JsonVoTransform evt) throws BusinessException {
...
//		clearContrast();
	...
	private void afterEditFreecust(JsonVoTransform e) {
//		UIRefPane refPane = (UIRefPane) getHeadItemUIRefPane(e.getKey());
...
//		}
	 ...
	 * @throws BusinessException
	 */
	private void afterEditBZBM(JsonVoTransform e) throws BusinessException {
...
//		}
	...
	public void resetBodyCShare(JsonVoTransform e) {
...
//		JsonVoTransform e_pk_org_v = new JsonVoTransform(event.getSource(), event.getNewValue(), JKBXHeaderVO.PK_ORG_V);
//		JsonVoTransform e_pk_payorg_v = new JsonVoTransform(event.getSource(), event.getNewValue(),

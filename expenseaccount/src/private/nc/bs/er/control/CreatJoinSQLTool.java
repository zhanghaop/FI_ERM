...
public class CreatJoinSQLTool {
	...
	private final String[][] DirectQuery = new String[][] {
			{ "zb", "hbbm", "bd_cubasdoc", "ksda", "pk_cubasdoc", "arap_djfb" },// 客商档案
																				// ksda
																				// -custname
			{ "ksda", "pk_cubasdoc1", "bd_cubasdoc", "kszgs", "pk_cubasdoc", "arap_djfb" },/* 客商总公司 */
			{ "zb", "deptid", "bd_deptdoc", "bmda", "pk_deptdoc", "arap_djfb" },// 部门档案
																				// bmda
																				// -deptname
			{ "zb", "fydeptid", "bd_deptdoc", "zrbmda", "pk_deptdoc", "arap_djfb" },// 部门档案
																					// bmda
																					// -deptname
			{ "fb", "jobid", "bd_jobbasfil", "xmda", "pk_jobbasfil", "arap_djfb" },// 项目档案
																					// xmda
																					// -jobname
			{ "zb", "bzbm", "bd_currtype", "bzda", "pk_currtype", "arap_djfb" },// 币种档案
																				// bzda
																				// -currname
			{ "fb", "jkbxr", "bd_psndoc", "ywyda", "pk_psndoc", "arap_djfb" },// 业务员档案
																				// ywyda
																				// -psnname
			{ "zb", "lrr", "sm_user", "lrrda", "cuserid", "arap_djzb" },// 录入人档案
																		// lrrda
																		// -psnname
			{ "zb", "shr", "sm_user", "shrda", "cuserid", "arap_djzb" },// 审核人档案
																		// shrda
																		// -psnname

			{ "fb", "cinventoryid", "bd_invbasdoc", "chda", "pk_invbasdoc", "arap_djfb" },// 存货档案
																							// chda
																							// -invname
			{ "fb", "xmbm2", "bd_jobmngfil", "xmglda", "pk_jobmngfil", "arap_djfb" },// 项目管理档案
																						// xmglda
			{ "zb", "hbbm", "bd_cumandoc", "ksglda", "pk_cubasdoc", "arap_djfb" },// 客商管理档案
																					// ksglda
			{ "fb", "chbm_cl", "bd_invmandoc", "chglda", "pk_invmandoc", "arap_djfb" },// 存货管理档案
																						// chglda
			{ "zb", "ywbm", "arap_djlx", "djlxda", "djlxoid", "arap_djzb" },// 单据类型档案
																			// djlxda
																			// -djjc

			{ "zb", "zdr", "sm_user", "zdrda", "cuserid", "arap_djzb" },// 制单人档案
																		// zdrda
																		// -psnname
			{ "zb", "qrr", "sm_user", "qrrda", "cuserid", "arap_djzb" },// 确认人档案
																		// qrrda
																		// -psnname
			{ "zb", "yhqrr", "sm_user", "yhqrrda", "cuserid", "arap_djzb" },// 银行确认人档案
																			// yhqrrda
																			// -psnname
			{ "fb", "accountid", "bd_accid", "zhda", "pk_accid", "arap_djfb" },// 账户档案
																				// zhda
																				// -accidname
			{ "fb", "szxmid", "bd_costsubj", "szxmda", "pk_costsubj", "arap_djfb" },// 收支项目档案
																					// szxmda
																					// -costname
			{ "zb", "dwbm", "bd_corp", "corp", "pk_corp", "arap_djzb" }, /**
			 * 单位档案
			 * corp -unitname
			 */
			{ "fb", "Pj_Jsfs", "bd_balatype", "jsfsda", "pk_balatype", "arap_djfb" }, /**
			 * 
			 * 结算方式
			 */
			...
			{ "zb", "xslxbm", "bd_busitype", "ywlxda", "pk_busitype", "arap_djzb" },// 业务类型
																					// businame
			{ "fb", "ddh", "arap_djfb", "fb", "ddh", "arap_djfb" },// 订单号
			{ "fb", "fb_oid", "arap_djfkxyb", "xyb", "fb_oid", "arap_djfb" },// 付款协议表

			{ "zhda", "pk_accbank", "bd_accbank", "yhda", "pk_accbank", "arap_djfb" },// 账号
																						// yhda
																						// -bankacc
			{ "ksda", "pk_areacl", "bd_areacl", "dqfl", "pk_areacl", "arap_djfb" },// 地区分类
																					// dqfl
																					// -areaclname
			{ "ksda", "pk_cubasdoc1", "bd_cubasdoc", "kszgs", "pk_cubasdoc", "arap_djfb" },// 客商总公司
																							// kszgs
																							// -custname
			{ "ksglda", "pk_respdept1", "bd_deptdoc", "zgbm", "pk_deptdoc", "arap_djfb" },// 专管部门
																							// zgbm
																							// -deptname
			{ "ksglda", "pk_resppsn1", "bd_psndoc", "zgywy", "pk_psndoc", "arap_djfb" },// 专管业务员
																						// zgywy
																						// -psnname
			{ "zhda", "pk_currtype", "bd_currtype", "zhbb", "pk_currtype", "arap_djfb" },// 帐户币别
																							// zhbb
																							// -currtypename
			{ "chda", "pk_invcl", "bd_invcl", "chfl", "pk_invcl", "arap_djfb" },// 存货分类
																				// chfl
																				// -invclassname
	...
	/**
	 * 功能:判断多公司查询时，是否设置了数据权限 作者：宋涛 创建时间：(2004-06-18 10:40:34) 使用说明：以及别人可能感兴趣的介绍
	 * 注意：现存Bug
	 * 
	 * 
	 * @return boolean
	...
	public boolean checkLegal(String[] pk_corps) throws java.lang.Exception {
		// nc.bs.bd.datapower.DatapowerusedDMO dmo = new
		// nc.bs.bd.datapower.DatapowerusedDMO();
	...
	/**
	 * 功能:得到已经关联的表简称 作者：宋涛 创建时间：(2004-03-13 10:59:32) 使用说明：以及别人可能感兴趣的介绍 注意：现存Bug
	 * 
	 * 
	...
	/**
	 * 功能:得到表关联规则定义 作者：宋涛 创建时间：(2004-03-13 10:53:13) 使用说明：以及别人可能感兴趣的介绍 注意：现存Bug
	 * 
	 * 
	 * @return java.util.Hashtable
	 */
	...
	/**
	 * 根据一组查询目标表简称，获得最精简的连接路径(left outer join) 如果 DirectQuery 的目标表简称和
	 * IndirectQuery 的关联表简称相同，可以简化一次连接 创建日期：(2001-5-18 11:35:24)
	 * 
	 * @return java.lang.String
	 * @param sTargetTab
	 *            java.lang.String[] 目标表名简称
	 */
	...
	/**
	 * 功能：根据查询对象、显示列、常用条件和自定义条件得到表连接sql片断 作者：宋涛 创建时间：(2001-10-22 18:37:48)
	 * 参数：<|> 返回值： 算法：为了提高查询效率减少sql中关联的表数量，修改原方法得到
	 */
	public String getJoinSQL(String[] sObjs, String[] sDisplays, QryCondArrayVO[] voNormalCond, Vector vetCustomCond)
			throws Exception {
		...
		String[] strTabs = null;
		// NewPubMethods.getInstance().getCustCondTabName(vetCustomCond,
		// vetTab);
		return getJoinSQL(strTabs);
	}

	/**
	 * 功能：根据查询对象、显示列、常用条件和自定义条件得到表连接sql片断(带有表名后缀) 作者：宋涛 创建时间：(2001-10-22
	 * 18:37:48) 参数：<|> 返回值： 算法：为了提高查询效率减少sql中关联的表数量，修改原方法得到
	 */
	public String getJoinSQL(String[] sObjs, String[] sDisplays, QryCondArrayVO[] voNormalCond, Vector vetCustomCond,
			String sAppend) throws Exception {
		setAppend(sAppend);
	...
	/**
	 * 根据一组查询目标vo，获得最精简的连接路径和子查询的select片断 如果 DirectQuery 的目标表简称和 IndirectQuery
	 * 的关联表简称相同，可以简化一次连接
	 * 
	 * 将查询对象VO整理成核心方法能够识别的字符串数组；同时维护m_sSelectFldOut
	 * 
	 * see getJoinSQL(String[][],boolean[]); 修改：修改了当需要在表名后添加后缀时在 tab.fld
	 * tab_fld中的表名后没有添加后缀的错误 修改人：宋涛
	 */
	 ...
	 *            java.util.Vector
	 */
	public String getJoinSQL(Vector<QryObjVO> vetObj, Vector<QryObjVO> vetDisplay, QryCondArrayVO[] voNormalCond,
			Vector vetCustomCond) throws Exception {
		// Vector<String> vetTab = new Vector<String>();
		// vetTab = NewPubMethods.getInstance().getObjTabs(vetObj,vetTab);
		// vetTab = NewPubMethods.getInstance().getObjTabs(vetDisplay,vetTab);
		// vetTab = NewPubMethods.getInstance().getTabs(voNormalCond,vetTab);
	 ...
	 */
	public String getJoinSQL(Vector<QryObjVO> vetObj, Vector<QryObjVO> vetDisplay, QryCondArrayVO[] voNormalCond,
			Vector vetCustomCond, String sAppend) throws Exception {
		setAppend(sAppend);
		return getJoinSQL(vetObj, vetDisplay, voNormalCond, vetCustomCond);
	}

	/**
	 * 功能:根据表名称得到相应的查询sql 作者：宋涛 创建时间：(2004-03-13 10:31:12) 使用说明：以及别人可能感兴趣的介绍
	 * 注意：现存Bug
	 * 
	 * 
	 * @return java.lang.String
	 ...
	 *            boolean
	 */
	private String getJoinSqlByTabName(String sTabName, boolean bOuterJoin, boolean bFromBill) throws Exception {
		try {
			...
			if (!bFromBill && (sSourceTab.equalsIgnoreCase("zb") || sSourceTab.equalsIgnoreCase("fb"))) {
				return "";
			}
			...
			throw new BusinessException(nc.bs.ml.NCLangResOnserver.getInstance().getStrByID("20060504",
					"UPP20060504-000065")/* @res "找不到相应的表连接规则定义" */
					+ sTabName);
		}
	}
	...
	/**
	 * 此处插入方法描述。 创建日期：(2003-10-17 14:17:16)
	 * 
	...
	// }
	/**
	 * 取得数据权限对应关系Hashtable。 创建日期：(2003-10-17 14:18:42)
	 */
	...
	// // String[]
	// tableShowName=tableName==null?null:PubPowerCtrlVO.getDocTabNames();
	// // m_hPower = boPower.getDataPower(tableName, pk_corp, userID);
	// return m_hPower;
	// }
	/**
	 * 功能:得到数据权限相关的表连接 作者：宋涛 创建时间：(2004-03-13 11:27:27) 使用说明：以及别人可能感兴趣的介绍
	 * 注意：现存Bug
	 * 
	 * 
	 * @return java.lang.String
	...
	// if (!needControl(sRule[2]) || (!isIszrdeptidusepower() &&
	// "zrbmda".equals(sRule[3]))) { /*启用了但是不需要控制数据权限*/
	// continue;
	// }
	...
	// }
	/**
	 * 功能:得到受数据权限控制的别表名 作者：宋涛 创建时间：(2004-05-11 16:45:19) 使用说明：以及别人可能感兴趣的介绍
	 * 注意：现存Bug
	 * 
	 * 
	 * @return java.lang.String[]
	...
	/**
	 * a功能: 作者：宋涛 创建时间：(2004-03-22 19:26:46) 使用说明：以及别人可能感兴趣的介绍 注意：现存Bug
	 * 
	 * 
	 * @return java.lang.String
	 * @param sParam
	...
	/**
	 * 功能:判断数据权限表是做控制还是做判断 作者：宋涛 创建时间：(2004-05-12 13:17:11) 使用说明：以及别人可能感兴趣的介绍
	 * 注意：true是控制，false是判断
	 * 
	 * 
	 * @return boolean
	...
	/**
	 * 功能:是否需要数据权限控制 作者：宋涛 创建时间：(2004-03-31 16:07:27) 使用说明：以及别人可能感兴趣的介绍 注意：现存Bug
	 * 
	 * 
	 * @return boolean
	 * @param sTabAlais
	...
	// }
	/**
	 * 设置表名后附加的字符 创建日期：(2001-6-5 16:09:57)
	 * 
	 * @param s
	 *            java.lang.String
	 */
	...
	/**
	 * a功能: 作者：宋涛 创建时间：(2004-05-12 13:17:11) 使用说明：以及别人可能感兴趣的介绍 注意：现存Bug
	 * 
	 * 
	 * @param newPowerCtrl
	 *            boolean
	...
	/**
	 * 设置代替主、辅表的字符 创建日期：(2001-6-5 16:09:57)
	 * 
	 * @param s
	 *            java.lang.String
	 */
	...
	public String[][] getQryObjs(Vector vetQryObj) throws Exception {
		...
		for (int i = 0; i < vetQryObj.size(); i++) {
			...
			// vBoth.addElement("" + vTabPotFld.lastElement() + " " +
			// vTab_Fld.lastElement());
			// vNULLFld.addElement("'' " + vTab_Fld.lastElement());
			// if(voQryObj.getPk_bdinfo()!=null){
			// BdinfoVO bdinfo =
			// (BdinfoVO)BdinfoManager.getBdInfoVO(voQryObj.getPk_bdinfo()).clone();
			...
			// formula
			// ="getColValue(\""+bdinfo.getTablename()+"\",\""+bdinfo.getBaseDocTablePkName()+"\", \""+bdinfo.getTablepkname()+"\","+sTab
			// + "_" + sFld+")";
			// }
			// bdinfo.setTablename(bdinfo.getBaseDocTableName());
			// bdinfo.setTablepkname(bdinfo.getBaseDocTablePkName());
			// }
			// vFormula.addElement( sTab + "_" +
			// sFld+"_code->getColValue("+bdinfo.getTablename()+","+bdinfo.getCodefieldname()+", "+bdinfo.getTablepkname()+","+formula+")");
			// vFormula.addElement( sTab + "_" +
			// sFld+"_name->getColValue("+bdinfo.getTablename()+","+bdinfo.getNamefieldname()+", "+bdinfo.getTablepkname()+","+formula+")");
			// }else{
			// if (sCode != null)
			...
			// sFld+"_name->getColValue("+bdinfo.getTablename()+","+bdinfo.getNamefieldname()+", "+bdinfo.getTablepkname()+","+formula+")");
			// }else{
			// if(sTab.equalsIgnoreCase("zhda")&&
			// sFld.equalsIgnoreCase("accflag")){
			// vFormula.addElement( sTab + "_" + sFld+"_code->"+sTab + "_" +
			// sFld);
			// vFormula.addElement( sTab + "_" +
			// sFld+"_name->iif(zhda_accflag==0,getlangres(\"20060504\",\"UPP20060504-000178\") , iif(zhda_accflag==1,getlangres(\"20060504\",\"UPP20060504-000181\"),getlangres(\"20060504\",\"UPP20060504-000182\") ))");
			// }else if(sTab.equalsIgnoreCase("fb")&&
			// sFld.equalsIgnoreCase("ddh")){
			// vFormula.addElement( sTab + "_" + sFld+"_code->"+sTab + "_" +
			// sFld);
			// vFormula.addElement( sTab + "_" + sFld+"_name->"+sTab + "_" +
			// sFld);
			// }else{
			// vFormula.addElement("");
			// // vFormula.addElement( sTab + "_" + sFld+"_code->"+sTab + "_" +
		...
		return new String[][] { sTabPotFld, sTab_Fld, sBoth, sNULLFld, sFormula, sName };
	}

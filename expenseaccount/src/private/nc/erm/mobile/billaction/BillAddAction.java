...
public class BillAddAction {
	...
	public void setJKBXValue(Object resVO,Object object) throws BusinessException {
		if(object == null){
			return;
		}
		billvo = object;
...
//				helper.getAfterEditUtil().initPayorgentityItems(false);
				...
				// 报销标准处理<6>
				doReimRuleAction((JKBXVO)object);
...
//				filterHeadItem();
				...
				//设置界面多版本
				setHeadOrgMultiVersion(new String[] { JKBXHeaderVO.PK_ORG_V, JKBXHeaderVO.FYDWBM_V,
				...
				setHeadDeptMultiVersion(JKBXHeaderVO.DEPTID_V, parentVO.getDwbm(),
						JKBXHeaderVO.DEPTID);
				setHeadDeptMultiVersion(JKBXHeaderVO.FYDEPTID_V, parentVO.getFydwbm(),
...
//				MultiVersionUtil.setBodyOrgMultiVersion(BXBusItemVO.PK_PCORG_V, BXBusItemVO.PK_PCORG, this);
	...
	public void setHeadOrgMultiVersion(String[] fields, String[] ofields)
		...
		for (int i = 0; i < fields.length; i++) {
			...
			if(value == null)
				continue;
			MultiVersionUtil.setHeadOrgMultiVersion(fields[i], value.toString(), (JKBXVO)billvo);
		}
	}
	public void setHeadDeptMultiVersion(String field_v, String pk_org, String field) throws BusinessException {
		...
		MultiVersionUtil.setHeadDeptMultiVersion(field_v, pk_org, value, ((JKBXVO)billvo).getParentVO());
	}
